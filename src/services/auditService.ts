...
export const AUDIT_ACTIONS = {
  ...
  // Discounts
  DISCOUNT_RULE_CREATE: 'DISCOUNT_RULE_CREATE',
  DISCOUNT_RULE_UPDATE: 'DISCOUNT_RULE_UPDATE',
  DISCOUNT_RULE_DELETE: 'DISCOUNT_RULE_DELETE',
  DISCOUNT_BILL_DISABLE: 'DISCOUNT_BILL_DISABLE',
  DISCOUNT_BILL_ENABLE: 'DISCOUNT_BILL_ENABLE',
  DISCOUNT_GLOBAL_QTY_ENABLE: 'DISCOUNT_GLOBAL_QTY_ENABLE',
  DISCOUNT_GLOBAL_QTY_DISABLE: 'DISCOUNT_GLOBAL_QTY_DISABLE',
  DISCOUNT_CALC_FAIL: 'DISCOUNT_CALC_FAIL',
} as const;
